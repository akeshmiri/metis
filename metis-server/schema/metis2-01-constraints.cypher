...
// [enterprise-only] CREATE CONSTRAINT model_version_source_episode_id_required IF NOT EXISTS FOR (n:ModelVersion) REQUIRE n.source_episode_id IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT model_version_name_required IF NOT EXISTS FOR (n:ModelVersion) REQUIRE n.name IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT model_version_journey_required IF NOT EXISTS FOR (n:ModelVersion) REQUIRE n.journey IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT model_version_surface_required IF NOT EXISTS FOR (n:ModelVersion) REQUIRE n.surface IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT model_version_version_required IF NOT EXISTS FOR (n:ModelVersion) REQUIRE n.version IS NOT NULL;
...
// [enterprise-only] CREATE CONSTRAINT revision_source_episode_id_required IF NOT EXISTS FOR (n:Revision) REQUIRE n.source_episode_id IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT revision_name_required IF NOT EXISTS FOR (n:Revision) REQUIRE n.name IS NOT NULL;
...
// [enterprise-only] CREATE CONSTRAINT run_source_episode_id_required IF NOT EXISTS FOR (n:Run) REQUIRE n.source_episode_id IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT run_name_required IF NOT EXISTS FOR (n:Run) REQUIRE n.name IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT run_criterion_required IF NOT EXISTS FOR (n:Run) REQUIRE n.criterion IS NOT NULL;
...
// [enterprise-only] CREATE CONSTRAINT test_path_source_episode_id_required IF NOT EXISTS FOR (n:TestPath) REQUIRE n.source_episode_id IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT test_path_name_required IF NOT EXISTS FOR (n:TestPath) REQUIRE n.name IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT test_path_criterion_required IF NOT EXISTS FOR (n:TestPath) REQUIRE n.criterion IS NOT NULL;
// [enterprise-only] CREATE CONSTRAINT test_path_generator_version_required IF NOT EXISTS FOR (n:TestPath) REQUIRE n.generator_version IS NOT NULL;
