...
CREATE CONSTRAINT action_source_episode_id_required IF NOT EXISTS FOR (n:Action) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT action_name_required IF NOT EXISTS FOR (n:Action) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT action_element_type_required IF NOT EXISTS FOR (n:Action) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT api_call_source_episode_id_required IF NOT EXISTS FOR (n:ApiCall) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT api_call_name_required IF NOT EXISTS FOR (n:ApiCall) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT api_call_trigger_required IF NOT EXISTS FOR (n:ApiCall) REQUIRE n.trigger IS NOT NULL;
CREATE CONSTRAINT api_call_guard_expression_required IF NOT EXISTS FOR (n:ApiCall) REQUIRE n.guard_expression IS NOT NULL;
CREATE CONSTRAINT api_call_implementation_status_required IF NOT EXISTS FOR (n:ApiCall) REQUIRE n.implementation_status IS NOT NULL;
CREATE CONSTRAINT api_call_surface_required IF NOT EXISTS FOR (n:ApiCall) REQUIRE n.surface IS NOT NULL;
...
CREATE CONSTRAINT business_area_source_episode_id_required IF NOT EXISTS FOR (n:BusinessArea) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT business_area_name_required IF NOT EXISTS FOR (n:BusinessArea) REQUIRE n.name IS NOT NULL;
...
CREATE CONSTRAINT business_entity_source_episode_id_required IF NOT EXISTS FOR (n:BusinessEntity) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT business_entity_name_required IF NOT EXISTS FOR (n:BusinessEntity) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT business_entity_description_required IF NOT EXISTS FOR (n:BusinessEntity) REQUIRE n.description IS NOT NULL;
...
CREATE CONSTRAINT check_source_episode_id_required IF NOT EXISTS FOR (n:Check) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT check_name_required IF NOT EXISTS FOR (n:Check) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT check_expression_required IF NOT EXISTS FOR (n:Check) REQUIRE n.expression IS NOT NULL;
...
CREATE CONSTRAINT class_source_episode_id_required IF NOT EXISTS FOR (n:Class) REQUIRE n.source_episode_id IS NOT NULL;
...
CREATE CONSTRAINT code_item_source_episode_id_required IF NOT EXISTS FOR (n:CodeItem) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT code_item_name_required IF NOT EXISTS FOR (n:CodeItem) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT code_item_repo_id_required IF NOT EXISTS FOR (n:CodeItem) REQUIRE n.repo_id IS NOT NULL;
...
CREATE CONSTRAINT column_source_episode_id_required IF NOT EXISTS FOR (n:Column) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT column_name_required IF NOT EXISTS FOR (n:Column) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT column_data_type_required IF NOT EXISTS FOR (n:Column) REQUIRE n.data_type IS NOT NULL;
...
CREATE CONSTRAINT component_source_episode_id_required IF NOT EXISTS FOR (n:Component) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT component_name_required IF NOT EXISTS FOR (n:Component) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT component_journey_required IF NOT EXISTS FOR (n:Component) REQUIRE n.journey IS NOT NULL;
CREATE CONSTRAINT component_surface_required IF NOT EXISTS FOR (n:Component) REQUIRE n.surface IS NOT NULL;
CREATE CONSTRAINT component_version_required IF NOT EXISTS FOR (n:Component) REQUIRE n.version IS NOT NULL;
CREATE CONSTRAINT component_component_required IF NOT EXISTS FOR (n:Component) REQUIRE n.component IS NOT NULL;
...
CREATE CONSTRAINT confluence_item_source_episode_id_required IF NOT EXISTS FOR (n:ConfluenceItem) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT confluence_item_name_required IF NOT EXISTS FOR (n:ConfluenceItem) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT confluence_item_page_id_required IF NOT EXISTS FOR (n:ConfluenceItem) REQUIRE n.page_id IS NOT NULL;
...
CREATE CONSTRAINT database_source_episode_id_required IF NOT EXISTS FOR (n:Database) REQUIRE n.source_episode_id IS NOT NULL;
...
CREATE CONSTRAINT datasource_source_episode_id_required IF NOT EXISTS FOR (n:Datasource) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT datasource_name_required IF NOT EXISTS FOR (n:Datasource) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT datasource_dialect_required IF NOT EXISTS FOR (n:Datasource) REQUIRE n.dialect IS NOT NULL;
...
CREATE CONSTRAINT datasource_item_source_episode_id_required IF NOT EXISTS FOR (n:DatasourceItem) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT datasource_item_name_required IF NOT EXISTS FOR (n:DatasourceItem) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT datasource_item_datasource_id_required IF NOT EXISTS FOR (n:DatasourceItem) REQUIRE n.datasource_id IS NOT NULL;
...
CREATE CONSTRAINT db_object_source_episode_id_required IF NOT EXISTS FOR (n:DbObject) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT db_object_name_required IF NOT EXISTS FOR (n:DbObject) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT db_object_object_type_required IF NOT EXISTS FOR (n:DbObject) REQUIRE n.object_type IS NOT NULL;
...
CREATE CONSTRAINT declared_outcome_source_episode_id_required IF NOT EXISTS FOR (n:DeclaredOutcome) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT declared_outcome_name_required IF NOT EXISTS FOR (n:DeclaredOutcome) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT declared_outcome_signature_required IF NOT EXISTS FOR (n:DeclaredOutcome) REQUIRE n.signature IS NOT NULL;
...
CREATE CONSTRAINT dialog_source_episode_id_required IF NOT EXISTS FOR (n:Dialog) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT dialog_name_required IF NOT EXISTS FOR (n:Dialog) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT dialog_element_type_required IF NOT EXISTS FOR (n:Dialog) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT endpoint_source_episode_id_required IF NOT EXISTS FOR (n:Endpoint) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT endpoint_name_required IF NOT EXISTS FOR (n:Endpoint) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT endpoint_http_method_required IF NOT EXISTS FOR (n:Endpoint) REQUIRE n.http_method IS NOT NULL;
CREATE CONSTRAINT endpoint_path_required IF NOT EXISTS FOR (n:Endpoint) REQUIRE n.path IS NOT NULL;
...
CREATE CONSTRAINT entity_document_source_episode_id_required IF NOT EXISTS FOR (n:EntityDocument) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT entity_document_name_required IF NOT EXISTS FOR (n:EntityDocument) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT entity_document_body_markdown_required IF NOT EXISTS FOR (n:EntityDocument) REQUIRE n.body_markdown IS NOT NULL;
CREATE CONSTRAINT entity_document_content_hash_required IF NOT EXISTS FOR (n:EntityDocument) REQUIRE n.content_hash IS NOT NULL;
CREATE CONSTRAINT entity_document_rendered_at_required IF NOT EXISTS FOR (n:EntityDocument) REQUIRE n.rendered_at IS NOT NULL;
...
CREATE CONSTRAINT event_source_episode_id_required IF NOT EXISTS FOR (n:Event) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT event_name_required IF NOT EXISTS FOR (n:Event) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT event_element_type_required IF NOT EXISTS FOR (n:Event) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT exception_mapping_source_episode_id_required IF NOT EXISTS FOR (n:ExceptionMapping) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT exception_mapping_name_required IF NOT EXISTS FOR (n:ExceptionMapping) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT exception_mapping_exception_type_required IF NOT EXISTS FOR (n:ExceptionMapping) REQUIRE n.exception_type IS NOT NULL;
CREATE CONSTRAINT exception_mapping_status_required IF NOT EXISTS FOR (n:ExceptionMapping) REQUIRE n.status IS NOT NULL;
...
CREATE CONSTRAINT feature_source_episode_id_required IF NOT EXISTS FOR (n:Feature) REQUIRE n.source_episode_id IS NOT NULL;
...
CREATE CONSTRAINT field_source_episode_id_required IF NOT EXISTS FOR (n:Field) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT field_name_required IF NOT EXISTS FOR (n:Field) REQUIRE n.name IS NOT NULL;
...
CREATE CONSTRAINT form_source_episode_id_required IF NOT EXISTS FOR (n:Form) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT form_name_required IF NOT EXISTS FOR (n:Form) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT form_element_type_required IF NOT EXISTS FOR (n:Form) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT function_source_episode_id_required IF NOT EXISTS FOR (n:Function) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT function_name_required IF NOT EXISTS FOR (n:Function) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT function_object_type_required IF NOT EXISTS FOR (n:Function) REQUIRE n.object_type IS NOT NULL;
...
CREATE CONSTRAINT intent_source_episode_id_required IF NOT EXISTS FOR (n:Intent) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT intent_name_required IF NOT EXISTS FOR (n:Intent) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT intent_statement_required IF NOT EXISTS FOR (n:Intent) REQUIRE n.statement IS NOT NULL;
...
CREATE CONSTRAINT menu_source_episode_id_required IF NOT EXISTS FOR (n:Menu) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT menu_name_required IF NOT EXISTS FOR (n:Menu) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT menu_element_type_required IF NOT EXISTS FOR (n:Menu) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT method_source_episode_id_required IF NOT EXISTS FOR (n:Method) REQUIRE n.source_episode_id IS NOT NULL;
...
CREATE CONSTRAINT navigation_source_episode_id_required IF NOT EXISTS FOR (n:Navigation) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT navigation_name_required IF NOT EXISTS FOR (n:Navigation) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT navigation_element_type_required IF NOT EXISTS FOR (n:Navigation) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT open_api_item_source_episode_id_required IF NOT EXISTS FOR (n:OpenApiItem) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT open_api_item_name_required IF NOT EXISTS FOR (n:OpenApiItem) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT open_api_item_document_id_required IF NOT EXISTS FOR (n:OpenApiItem) REQUIRE n.document_id IS NOT NULL;
...
CREATE CONSTRAINT page_source_episode_id_required IF NOT EXISTS FOR (n:Page) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT page_name_required IF NOT EXISTS FOR (n:Page) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT page_component_required IF NOT EXISTS FOR (n:Page) REQUIRE n.component IS NOT NULL;
...
CREATE CONSTRAINT pagination_source_episode_id_required IF NOT EXISTS FOR (n:Pagination) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT pagination_name_required IF NOT EXISTS FOR (n:Pagination) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT pagination_element_type_required IF NOT EXISTS FOR (n:Pagination) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT parameter_source_episode_id_required IF NOT EXISTS FOR (n:Parameter) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT parameter_name_required IF NOT EXISTS FOR (n:Parameter) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT parameter_location_required IF NOT EXISTS FOR (n:Parameter) REQUIRE n.location IS NOT NULL;
...
CREATE CONSTRAINT rest_server_source_episode_id_required IF NOT EXISTS FOR (n:RestServer) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT rest_server_name_required IF NOT EXISTS FOR (n:RestServer) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT rest_server_journey_required IF NOT EXISTS FOR (n:RestServer) REQUIRE n.journey IS NOT NULL;
CREATE CONSTRAINT rest_server_surface_required IF NOT EXISTS FOR (n:RestServer) REQUIRE n.surface IS NOT NULL;
CREATE CONSTRAINT rest_server_version_required IF NOT EXISTS FOR (n:RestServer) REQUIRE n.version IS NOT NULL;
CREATE CONSTRAINT rest_server_component_required IF NOT EXISTS FOR (n:RestServer) REQUIRE n.component IS NOT NULL;
...
CREATE CONSTRAINT route_source_episode_id_required IF NOT EXISTS FOR (n:Route) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT route_name_required IF NOT EXISTS FOR (n:Route) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT route_path_required IF NOT EXISTS FOR (n:Route) REQUIRE n.path IS NOT NULL;
...
CREATE CONSTRAINT row_source_episode_id_required IF NOT EXISTS FOR (n:Row) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT row_name_required IF NOT EXISTS FOR (n:Row) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT row_element_type_required IF NOT EXISTS FOR (n:Row) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT scenario_source_episode_id_required IF NOT EXISTS FOR (n:Scenario) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT scenario_name_required IF NOT EXISTS FOR (n:Scenario) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT scenario_criterion_required IF NOT EXISTS FOR (n:Scenario) REQUIRE n.criterion IS NOT NULL;
CREATE CONSTRAINT scenario_generator_version_required IF NOT EXISTS FOR (n:Scenario) REQUIRE n.generator_version IS NOT NULL;
...
CREATE CONSTRAINT schema_source_episode_id_required IF NOT EXISTS FOR (n:Schema) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT schema_name_required IF NOT EXISTS FOR (n:Schema) REQUIRE n.name IS NOT NULL;
...
CREATE CONSTRAINT sort_source_episode_id_required IF NOT EXISTS FOR (n:Sort) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT sort_name_required IF NOT EXISTS FOR (n:Sort) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT sort_element_type_required IF NOT EXISTS FOR (n:Sort) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT spec_document_source_episode_id_required IF NOT EXISTS FOR (n:SpecDocument) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT spec_document_name_required IF NOT EXISTS FOR (n:SpecDocument) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT spec_document_body_markdown_required IF NOT EXISTS FOR (n:SpecDocument) REQUIRE n.body_markdown IS NOT NULL;
CREATE CONSTRAINT spec_document_content_hash_required IF NOT EXISTS FOR (n:SpecDocument) REQUIRE n.content_hash IS NOT NULL;
CREATE CONSTRAINT spec_document_rendered_at_required IF NOT EXISTS FOR (n:SpecDocument) REQUIRE n.rendered_at IS NOT NULL;
...
CREATE CONSTRAINT specification_source_episode_id_required IF NOT EXISTS FOR (n:Specification) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT specification_name_required IF NOT EXISTS FOR (n:Specification) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT specification_statement_required IF NOT EXISTS FOR (n:Specification) REQUIRE n.statement IS NOT NULL;
CREATE CONSTRAINT specification_provenance_required IF NOT EXISTS FOR (n:Specification) REQUIRE n.provenance IS NOT NULL;
...
CREATE CONSTRAINT table_source_episode_id_required IF NOT EXISTS FOR (n:Table) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT table_name_required IF NOT EXISTS FOR (n:Table) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT table_object_type_required IF NOT EXISTS FOR (n:Table) REQUIRE n.object_type IS NOT NULL;
...
CREATE CONSTRAINT test_case_steps_json_required IF NOT EXISTS FOR (n:TestCase) REQUIRE n.steps_json IS NOT NULL;
CREATE CONSTRAINT test_case_expected_result_required IF NOT EXISTS FOR (n:TestCase) REQUIRE n.expected_result IS NOT NULL;
...
CREATE CONSTRAINT ui_action_source_episode_id_required IF NOT EXISTS FOR (n:UiAction) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT ui_action_name_required IF NOT EXISTS FOR (n:UiAction) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT ui_action_trigger_required IF NOT EXISTS FOR (n:UiAction) REQUIRE n.trigger IS NOT NULL;
CREATE CONSTRAINT ui_action_guard_expression_required IF NOT EXISTS FOR (n:UiAction) REQUIRE n.guard_expression IS NOT NULL;
CREATE CONSTRAINT ui_action_implementation_status_required IF NOT EXISTS FOR (n:UiAction) REQUIRE n.implementation_status IS NOT NULL;
CREATE CONSTRAINT ui_action_surface_required IF NOT EXISTS FOR (n:UiAction) REQUIRE n.surface IS NOT NULL;
...
CREATE CONSTRAINT ui_element_source_episode_id_required IF NOT EXISTS FOR (n:UiElement) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT ui_element_name_required IF NOT EXISTS FOR (n:UiElement) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT ui_element_element_type_required IF NOT EXISTS FOR (n:UiElement) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT ui_table_source_episode_id_required IF NOT EXISTS FOR (n:UiTable) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT ui_table_name_required IF NOT EXISTS FOR (n:UiTable) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT ui_table_element_type_required IF NOT EXISTS FOR (n:UiTable) REQUIRE n.element_type IS NOT NULL;
...
CREATE CONSTRAINT view_source_episode_id_required IF NOT EXISTS FOR (n:View) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT view_name_required IF NOT EXISTS FOR (n:View) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT view_object_type_required IF NOT EXISTS FOR (n:View) REQUIRE n.object_type IS NOT NULL;
...
CREATE CONSTRAINT web_server_source_episode_id_required IF NOT EXISTS FOR (n:WebServer) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT web_server_name_required IF NOT EXISTS FOR (n:WebServer) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT web_server_journey_required IF NOT EXISTS FOR (n:WebServer) REQUIRE n.journey IS NOT NULL;
CREATE CONSTRAINT web_server_surface_required IF NOT EXISTS FOR (n:WebServer) REQUIRE n.surface IS NOT NULL;
CREATE CONSTRAINT web_server_version_required IF NOT EXISTS FOR (n:WebServer) REQUIRE n.version IS NOT NULL;
CREATE CONSTRAINT web_server_component_required IF NOT EXISTS FOR (n:WebServer) REQUIRE n.component IS NOT NULL;
...
CREATE CONSTRAINT zephyr_item_source_episode_id_required IF NOT EXISTS FOR (n:ZephyrItem) REQUIRE n.source_episode_id IS NOT NULL;
CREATE CONSTRAINT zephyr_item_name_required IF NOT EXISTS FOR (n:ZephyrItem) REQUIRE n.name IS NOT NULL;
CREATE CONSTRAINT zephyr_item_zephyr_key_required IF NOT EXISTS FOR (n:ZephyrItem) REQUIRE n.zephyr_key IS NOT NULL;
